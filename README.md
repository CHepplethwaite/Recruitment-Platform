...
Repository for Tumpe job board: www.tumpetech.com.
...
3. The webserver must only allow authorised IP addresses to access the admin site

4. The same security measures should be applied to the admin docs section