...
urlpatterns = [
    path('jobs/create-job/<int:pk>/', job_views.jobCreateView.as_view(), name="create_job"),
    ...
    path('jobs/', job_views.jobsListView.as_view(), name="job_list_admin_panel"),
    path('jobs/<int:pk>/', job_views.jobsDetailView.as_view(), name="job_detail_admin_panel"),
