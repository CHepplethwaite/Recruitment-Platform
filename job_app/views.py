...
class jobListView(ListView):
    model = job
    paginate_by = 10
    queryset=job.objects.filter(status__exact=f"{True}").order_by('-post_date')
...
class academiaListView(ListView):
    ...
    queryset=job.objects.filter(industry__exact="ACADEMIA", status__exact=f"{True}").order_by('-post_date')
...
class adminListView(ListView):
    ...
    queryset=job.objects.filter(industry__exact="ADMINISTRATION", status__exact=f"{True}").order_by('-post_date')
...
class accountancyListView(ListView):
    ...
    queryset=job.objects.filter(industry__exact="ACCOUNTANCY", status__exact=f"{True}").order_by('-post_date')
...
class agricultureListView(ListView):
    ...
    queryset=job.objects.filter(industry__exact="AGRICULTURE", status__exact=f"{True}").order_by('-post_date')
...
class bankingListView(ListView):
    ...
    queryset=job.objects.filter(industry__exact="BANKING_AND_FINANCE", status__exact=f"{True}").order_by('-post_date')
...
class developmentListView(ListView):
    ...
    queryset=job.objects.filter(industry__exact="DEVELOPMENT", status__exact=f"{True}").order_by('-post_date')
...
class engineeringListView(ListView):
    ...
    queryset=job.objects.filter(industry__exact="ENGINEERING_AND_CONSTRUCTION", status__exact=f"{True}").order_by('-post_date')
...
class healthListView(ListView):
    ...
    queryset=job.objects.filter(industry__exact="HEALTH", status__exact=f"{True}").order_by('-post_date')
...
class hrListView(ListView):
    ...
    queryset=job.objects.filter(industry__exact="HUMAN_RESOURCE", status__exact=f"{True}").order_by('-post_date')
...
class lawListView(ListView):
    ...
    queryset=job.objects.filter(industry__exact="LAW", status__exact=f"{True}").order_by('-post_date')
...
class manufacturingListView(ListView):
    ...
    queryset=job.objects.filter(industry__exact="MANUFACTURING_FMCG", status__exact=f"{True}").order_by('-post_date')
...
class miscListView(ListView):
    ...
    queryset=job.objects.filter(industry__exact="OTHER", status__exact=f"{True}").order_by('-post_date')
...
class retailListView(ListView):
    ...
    queryset=job.objects.filter(industry__exact="RETAIL_AND_SALES", status__exact=f"{True}").order_by('-post_date')
...
class techListView(ListView):
    ...
    queryset=job.objects.filter(industry__exact="ICT_AND_TELCO", status__exact=f"{True}").order_by('-post_date')
...
class publicSectorListView(ListView):
    ...
    queryset=job.objects.filter(industry__exact="PUBLIC_SECTOR", status__exact=f"{True}").order_by('-post_date')
...
class transportListView(ListView):
    ...
    queryset=job.objects.filter(industry__exact="TRANSPORT_AND_LOGISTICS", status__exact=f"{True}").order_by('-post_date')
